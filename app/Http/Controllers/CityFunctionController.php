...
class CityFunctionController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'safety' => 'nullable|integer|between:-10,10',
            'recreation' => 'nullable|integer|between:-10,10',
            'environment_quality' => 'nullable|integer|between:-10,10',
            'facilities' => 'nullable|integer|between:-10,10',
            'mobility' => 'nullable|integer|between:-10,10',
        ], [
