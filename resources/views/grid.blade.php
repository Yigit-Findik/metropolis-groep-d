<x-app-layout>
    ...
    <div class="py-12">
        <div class="px-4 sm:px-6 lg:px-8">
            ...
            {{-- QoL Score Banner --}}
              <div class="w-full bg-gray-600 dark:bg-gray-800 rounded-2xl shadow-sm px-8 py-6 mb-6 overflow-x-auto" role="group" aria-label="Quality of life summary">
                <div class="grid min-w-[720px] grid-cols-[150px_repeat(5,minmax(120px,1fr))] gap-x-4 gap-y-3 items-start">

                    {{-- Total score --}}
                    <div class="min-w-[120px]">
                        <p class="text-blue-200 dark:text-gray-300 text-xs font-medium uppercase tracking-wide" aria-hidden="true">Total QoL</p>
                    ...
                    @foreach(['safety' => 'Safety', 'recreation' => 'Recreation', 'environment_quality' => 'Environment Quality', 'facilities' => 'Facilities', 'mobility' => 'Mobility'] as $slug => $label)
                        <div>
                            <p class="text-blue-200 dark:text-gray-300 text-xs font-medium uppercase tracking-wide">{{ $label }}</p>
