<div class="grid gap-4">
    ...
    <div @if($model === 'creating') x-show="creating.event_type === 'recurring'" @else x-show="editing.event_type === 'recurring'" @endif class="rounded-2xl border border-cyan-200 hc:border-white bg-cyan-50/70 hc:bg-neutral-900 p-4 dark:border-cyan-500/20 dark:bg-cyan-500/10">
