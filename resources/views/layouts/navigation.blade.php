<nav x-data="navigation" class="sticky top-0 z-50 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div id="mobile-navigation-menu" :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
