        ...
        <div class="px-4 sm:px-6 lg:px-8">
            ...
            @if($selectedFunctionId)
                <div class="mb-6 rounded-2xl border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-900 dark:border-blue-900/40 dark:bg-blue-900/20 dark:text-blue-100">
                    Directe link actief voor functie-ID {{ $selectedFunctionId }}.
                </div>
            @endif
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse($functions as $function)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                                    {{-- Function Name Cell --}}
                                    <td id="function-{{ $function->id }}" class="px-6 py-4 text-sm font-medium text-gray-900 dark:text-gray-100 whitespace-nowrap @if($selectedFunctionId === $function->id) ring-2 ring-blue-400 ring-inset @endif @if($function->trashed()) opacity-70 @endif">
